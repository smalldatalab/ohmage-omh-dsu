...
import org.openmhealth.dsu.domain.ohmage.survey.Respondable;
...
public abstract class Prompt<ResponseType>
    ...
    /*
     * (non-Javadoc)
     * @see org.openmhealth.dsu.domain.ohmage.survey.response.Respondable#validateResponse(java.lang.Object, java.util.Map)
     */
    @Override
