...
import org.openmhealth.dsu.domain.survey.Respondable;
...
public abstract class Prompt<ResponseType>
    ...
    /*
     * (non-Javadoc)
     * @see org.openmhealth.dsu.domain.survey.response.Respondable#validateResponse(java.lang.Object, java.util.Map)
     */
    @Override
