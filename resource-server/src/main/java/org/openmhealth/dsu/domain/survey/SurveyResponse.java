package org.openmhealth.dsu.domain.survey;
...
import org.openmhealth.dsu.domain.jackson.OhmageObjectMapper;
import org.openmhealth.dsu.domain.jackson.OhmageObjectMapper.JsonFilterField;
...
public class SurveyResponse extends DataPoint<Map<String, Object>> {
    /**
     * <p>
     * A builder for {@link org.openmhealth.dsu.domain.survey.SurveyResponse} objects.
     * </p>
     *
     * @author John Jenkins
     */
    public static class Builder
        ...
        /**
         * Builds a new {@link org.openmhealth.dsu.domain.survey.SurveyResponse} object based on the current
         * state of this builder.
         *
         * @return the built {@link org.openmhealth.dsu.domain.survey.SurveyResponse} object.
         *
         * @throws InvalidArgumentException
         *         The state of this builder is insufficient to build a new
         *         {@link org.openmhealth.dsu.domain.survey.SurveyResponse} object.
         */
        @Override
         ...
         * {@link org.openmhealth.dsu.domain.survey.SurveyResponse} based on the current state of this builder.
         ...
         *        {@link org.openmhealth.dsu.domain.survey.SurveyResponse} result.
         *
         * @param media
         ...
         * @throws InvalidArgumentException
         *         The state of this builder is insufficient to build a new
         *         {@link org.openmhealth.dsu.domain.survey.SurveyResponse} object or the survey response is
         *         invalid.
         */
    ...
    protected static final String JACKSON_FILTER_GROUP_ID =
        "org.openmhealth.dsu.domain.survey.SurveyResponse";
