...
import org.openmhealth.dsu.domain.ohmage.survey.condition.conjunction.Conjunction;
...
public abstract class Fragment {
    ...
    public static interface Builder<T extends Fragment> {
         ...
         */
        public abstract Builder<?> merge(
                final Builder<?> other)
            throws InvalidArgumentException;

        /**
         * Builds the {@link org.openmhealth.dsu.domain.ohmage.survey.condition.Fragment} to which this builder is associated.
         *
         * @return The validated {@link org.openmhealth.dsu.domain.ohmage.survey.condition.Fragment} tree element.
         *
         * @throws InvalidArgumentException
     ...
     */
    public static Builder<?> parseWord(final String word) {
