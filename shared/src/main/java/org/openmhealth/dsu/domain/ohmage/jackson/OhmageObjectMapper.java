package org.openmhealth.dsu.domain.ohmage.jackson;
...
import org.openmhealth.dsu.domain.ohmage.ISOW3CDateTimeFormat;
...
//    		DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS);
    ...
    /**
	 * <p>
	 * Adds all fields marked with the {@link org.openmhealth.dsu.domain.ohmage.jackson.OhmageObjectMapper.JsonFilterField} annotation to
	 * this class' filter. This includes all fields at and above this class in
	 * its class hierarchy.
	 * </p>
	 *
	 * <p>
	 * The class must be annotated with a {@link com.fasterxml.jackson.annotation.JsonFilter} annotation, whose
	 * value must be unique to this class. It is generally recommended to use
	 * the class' package and name.
	 * </p>
	 *
	 * @param filterClass
	 *        The class to register, which must have a {@link com.fasterxml.jackson.annotation.JsonFilter}
	 *        annotation.
	 */
