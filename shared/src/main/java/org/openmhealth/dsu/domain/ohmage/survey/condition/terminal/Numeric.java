...
import org.openmhealth.dsu.domain.ohmage.jackson.OhmageNumber;
...
public class Numeric extends Terminal {
    /**
     * <p>
     * A builder for {@link org.openmhealth.dsu.domain.ohmage.survey.condition.terminal.Numeric} objects.
     * </p>
     *
     * @author John Jenkins
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.openmhealth.dsu.domain.ohmage.survey.condition.Terminal#getValue(java.util.Map)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.openmhealth.dsu.domain.ohmage.survey.condition.terminal.Terminal#lessThanValue(java.util.Map, java.lang.Object)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.openmhealth.dsu.domain.ohmage.survey.condition.terminal.Terminal#equalsValue(java.util.Map, java.lang.Object)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see org.openmhealth.dsu.domain.ohmage.survey.condition.terminal.Terminal#greaterThanValue(java.util.Map, java.lang.Object)
     */
    @Override
