...
public class MongoStepExecutionDao extends AbstractMongoDao implements StepExecutionDao {
    ...
    private DBObject toDbObjectWithoutVersion(StepExecution stepExecution) {
        return start()
                ...
                .add(FILTER_COUNT_KEY, stepExecution.getFilterCount())
                ...
                .add(PROCESS_SKIP_COUNT_KEY, stepExecution.getProcessSkipCount())
    ...
    private StepExecution mapStepExecution(DBObject object, JobExecution jobExecution) {
        ...
        stepExecution.setFilterCount((Integer) object.get(FILTER_COUNT_KEY));
        ...
        stepExecution.setProcessSkipCount((Integer) object.get(PROCESS_SKIP_COUNT_KEY));
    ...
    protected DBCollection getCollection() {
        return mongoTemplate.getCollection(STEP_EXECUTION_COLLECTION_NAME);
    }
