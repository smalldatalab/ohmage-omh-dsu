...
public abstract class AbstractMongoDao {
    ...
    public static final String EXECUTION_CONTEXT_COLLECTION_NAME = "batchExecutionContext";
    public static final String JOB_EXECUTION_COLLECTION_NAME = "batchJobExecution";
    public static final String JOB_INSTANCE_COLLECTION_NAME = "batchJobInstance";
    public static final String STEP_EXECUTION_COLLECTION_NAME = "batchStepExecution";
    public static final String SEQUENCES_COLLECTION_NAME = "batchSequences";
