...
public class MongoJobInstanceDao extends AbstractMongoDao implements JobInstanceDao {
    ...
    public JobInstance getJobInstance(JobExecution jobExecution) {
        DBObject instanceId = mongoTemplate.getCollection(JOB_EXECUTION_COLLECTION_NAME).findOne(jobExecutionIdObj(jobExecution.getId()), jobInstanceIdObj(1L));
    ...
    protected DBCollection getCollection() {
        return mongoTemplate.getCollection(JOB_INSTANCE_COLLECTION_NAME);
    }
