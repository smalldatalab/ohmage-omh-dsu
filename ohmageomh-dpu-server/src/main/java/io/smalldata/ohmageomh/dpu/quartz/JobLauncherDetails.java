package io.smalldata.ohmageomh.dpu.quartz;
...
public class JobLauncherDetails extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) {
        ...
        jobDataMap.put("tag", ZonedDateTime.now().format(DateTimeFormatter.ISO_INSTANT));
        ...
        try {
            ...
            log.error("Could not execute job: " + jobName, e);
        }
    }
