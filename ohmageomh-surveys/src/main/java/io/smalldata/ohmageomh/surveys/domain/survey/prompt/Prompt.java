...
import io.smalldata.ohmageomh.surveys.domain.survey.Respondable;
...
public abstract class Prompt<ResponseType>
    ...
    /*
     * (non-Javadoc)
     * @see io.smalldata.ohmageomh.surveys.domain.survey.response.Respondable#validateResponse(java.lang.Object, java.util.Map)
     */
    @Override
